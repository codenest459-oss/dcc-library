...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The modern operating system for the Dhaka City College library" },
      { property: "og:description", content: "The modern operating system for the Dhaka City College library" },
      { name: "twitter:description", content: "The modern operating system for the Dhaka City College library" },
